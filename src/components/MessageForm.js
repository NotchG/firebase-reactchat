      ...
      <div style={{backgroundColor: 'gray', height: 'fit-content'}}>
        <div className="u-form u-form-1" style={{width: '100%'}}>
          <form className="u-clearfix u-form-horizontal u-form-spacing-0 u-inner-form" source="custom" name="form" style={{padding: '0px'}}>
            ...
            <input type="file" id="img" accept='image/*' name="upload" style={{display: 'none'}} disabled={Disabled}/>
            </div>
            <div className="u-form-group u-form-name">
              <label for="name-5e66" className="u-form-control-hidden u-label"></label>
              <input type="text" placeholder={Disabled ? 'The other party has to be friends with you': 'message'} id="name-5e66" name="message" className="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" disabled={Disabled}/>
            </div>
